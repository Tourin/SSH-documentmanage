...
<body>
	${message}
	<div class="container">
		<form class="form" action="editPeriodical_doc" method="post"
					...
					<tbody>
						<tr class="form-item">
							...
							<td class="form-value"><input id="text" name="per.name"
								...
								data-validation-placement="right" value="${per.name}" /></td>
						</tr>
						<tr class="form-item">
							...
							<td class="form-value"><input id="number" name="per.number"
								...
								data-validation-placement="right" value="${per.number}" /></td>
						</tr>
						<tr class="form-item">
							...
							<td class="form-value"><input id="text" name="per.type"
								...
								data-validation-placement="right" value="${per.type}" /></td>
						</tr>
					</tbody>
					<tfoot>
						<tr>
			...
			<input type="hidden" name="per.infoUnit.unitId"
				value="${per.infoUnit.unitId}" />
			<input type="hidden" name="per.periodicalId"
				value="${per.periodicalId}" />
			<input type="hidden" name="per.path"
				value="${per.path}" />
		</form>
	</div>
	<!-- / .container -->
