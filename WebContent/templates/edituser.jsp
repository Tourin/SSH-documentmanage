...
<body>
	...
	<div class="container">
		<form class="form" action="editUser_acc" method="post">
					...
					<tbody>
						...
						<tr class="form-item">
							...
							<td class="form-value"><input id="number" name="user.age"
								...
								data-parent=".form-item" data-validation-error="数字有误，请重新填写"
						...
						<tr class="form-item">
							...
							<td class="form-value"><input id="idcard" name="user.idcard"
								...
								data-parent=".form-item" data-validation-error="身份证有误，请重新填写"
			...
			<input type="hidden" name="user.pass" value="${user.pass}"/>
		</form>
	</div>
	<!-- / .container -->
